...
public class BoSoruSQLiteHelper extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.example.tez/databases/BoSorular";
    private static final String Database_name = "BoSorular.db";//database ismi
    ...
    public BoSoruSQLiteHelper(Context context) {//constructor
