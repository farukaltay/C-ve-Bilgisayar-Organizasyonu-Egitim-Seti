...
public class YuksekSkorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new KullaniciAdapter(this, productList);
                            ...
                            for (DocumentSnapshot d : list) {
                                ...
                                Collections.sort(productList, new Comparator<Kullanici>() {
                                    ...
                                    public int compare(Kullanici p1, Kullanici p2) {
                                        if (p1.getCskor() < p2.getCskor()) {
                                            return 1;
                                        } else if (p1.getCskor() > p2.getCskor()) {
                                            return -1;
                                        }
                                        return 0;
                                    }
