...
public class CppSQLiteHelper extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.example.tez/databases/cppegitim";
    private static final String Database_name = "cppegitim.db";//database ismi
    ...
    private static final String Icerik = "cpp";//colom 3
    private static final String SecenekA = "cppA";//colom 4
    private static final String SecenekB = "cppB";//colom 5
    private static final String SecenekC = "cppC";//colom 6
    private static final String SecenekD = "cppD";//colom 7
    ...
    public CppSQLiteHelper(Context context) {//constructor
